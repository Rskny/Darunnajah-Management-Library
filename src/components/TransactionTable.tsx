...
export default function TransactionTable({ 
  ...
  return (
    <table className="w-full text-sm text-left border-collapse" style={{ minWidth: "1200px" }}>
            ...
            return (
              <tr key={t.id} className="hover:bg-slate-50 transition-colors group">
                ...
                <td className="px-6 py-4 text-slate-500 text-center whitespace-nowrap border-b border-slate-100">
                  {t.borrowDate ? new Date(t.borrowDate).toLocaleDateString("id-ID") : new Date(t.date).toLocaleDateString("id-ID")}
                </td>
                <td className="px-6 py-4 text-slate-500 text-center whitespace-nowrap border-b border-slate-100">
